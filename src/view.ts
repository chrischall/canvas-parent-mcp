 ...
 *
 * The read tools in this server hand back Canvas's payload close to
 ...
 * honestly say which of Canvas's fields matter and which are noise.
 *
...
const NOTE =
  'compact strips image/avatar URLs from the response; "full" returns Canvas\'s payload untouched. ' +
  'No field projection: this server has no verified record of which Canvas fields matter, and inventing ' +
