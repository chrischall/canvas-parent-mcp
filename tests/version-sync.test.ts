...
//
// The walk/compare logic is the fleet-shared `versionSyncTest` from
// `@chrischall/mcp-utils/test` (identical semver-literal regex + skip of
// marker-only docstring lines); this file just points it at this repo's
